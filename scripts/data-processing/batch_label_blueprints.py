...
from auto_offset_correction import detect_offset_by_wall_alignment
...
def draw_accurate_bounding_boxes(image_path, rooms_data, output_path, svg_width, svg_height):
    ...
    try:
        ...
        # Detect and apply offset correction
        print(f"    Detecting offset...", end=" ")
        try:
            offset_x, offset_y, _, _ = detect_offset_by_wall_alignment(str(svg_path), image_path)
            print(f"offset: x={offset_x}, y={offset_y}")
        except Exception as e:
            print(f"using default (0, 0) - {e}")
            ...
            for elem in root.iter():
                ...
                if 'Space' in class_attr and not class_attr.startswith('SpaceDimensions'):
                    ...
                    if polygon is not None:
                        ...
                        if svg_points:
                            # Transform to PNG coordinates with offset correction
                            png_points = [
